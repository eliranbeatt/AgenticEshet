...
function buildPromptHebrewMarkdown(args: {
    ...
    return [
        ...
        "- Do NOT use `[cite: ...]` markers.",
        "- Cite inline using clickable numbered links like: `[5](https://example.com)` (numbers only).",
        "- At the end, include a 'Sources' section as a numbered list where item 5 is the URL used for `[5](...)`.",
        "",
        ...
        "   - Inline citations via numbered links",
        "4. Risk notes (market volatility, lead times, availability)",
        "5. Sources (numbered list at the end)",
        "",
