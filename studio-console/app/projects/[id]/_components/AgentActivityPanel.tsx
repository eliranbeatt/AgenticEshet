...
export function AgentActivityPanel({ projectId }: { projectId: Id<"projects"> }) {
    ...
    return (
        <div className="fixed bottom-5 right-5 z-50 w-[380px] max-w-[calc(100vw-2.5rem)]">
            <div className="bg-white border rounded-lg shadow-lg overflow-hidden">
                <button
                    ...
                    className="w-full px-4 py-3 flex items-center justify-between gap-3 bg-gray-50 hover:bg-gray-100 border-b"
                >
                ...
                {isOpen && (
                    <div className="grid grid-cols-2">
                        <div className="border-r max-h-[360px] overflow-auto">
                            {(runs ?? []).length === 0 ? (
                        ...
                        <div className="max-h-[360px] overflow-auto">
                            {!selected ? (
                                ...
                                <div className="p-4 space-y-3">
                                    ...
                                    <div className="border rounded bg-gray-50 max-h-56 overflow-auto">
